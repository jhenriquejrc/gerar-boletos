...
var Pagador = (function () {
	...
	Pagador.prototype.getIdentificacao = function () {
		...
		if (tipo) {
			identificacao += [' (', tipo.toUpperCase(), ': ', this.getRegistroNacionalFormatado(), ')'].join('') || '';
		}
...
var Boleto = (function () {
	...
	Boleto.prototype.getParcelaFormatado = function () {
		return pad(this._parcela || '', 3, '0');
	};

	Boleto.prototype.comParcela = function (_parcela) {
		_parcela && _parcela !== '' ? (this._parcela = _parcela) : (this._parcela = '1');
		return this;
	};
